...
class CacheAspect extends aspect_1.SurroundAspect {
...
function cache(cachingService, keyIndex, period) {
    return aspect_1.aspect(new CacheAspect(cachingService, keyIndex, false, period), aspect_1.Target.All ^ aspect_1.Target.Constructor);
}
exports.cache = cache;
function invalidateCache(cachingService, keyIndex) {
    return aspect_1.aspect(new CacheAspect(cachingService, keyIndex, true), aspect_1.Target.All ^ aspect_1.Target.Constructor);
}
